...
def q1(string: str) -> bool:
    return (len(string) > 0 and string[0] == 'I' and q2(string[1:]))
...
def q3(string: str) -> bool:
    return (len(string) > 0 and string[0] == 'eps' and q4(string[1:])) or (len(string) > 0 and string[0] == 'eps' and q6(string[1:]))


def q4(string: str) -> bool:
    return (len(string) > 0 and string[0] == 'X' and q5(string[1:]))
...
def q6(string: str) -> bool:
    return (len(string) > 0 and string[0] == 'm' and q7(string[1:]))


def q7(string: str) -> bool:
    return (len(string) > 0 and string[0] == 'eps' and q8(string[1:]))


def q8(string: str) -> bool:
    return (len(string) > 0 and string[0] == 'T' and q9(string[1:]))
