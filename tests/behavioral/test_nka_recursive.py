from behavioral.data.nka_recursive import student_b, student_a, student_infinite_loop, student_wrong, student_random
import importlib.util
import sys

from graders.behavioral.generator.utils.safe_call import safe_call
...
def test_student_a():
    reference, ast = prepare_reference_automaton(
        ...
        path="tests/behavioral/data/nka_recursive/reference_a.py"
    )
...
def test_student_b():
    reference, ast = prepare_reference_automaton(
        ...
        path="tests/behavioral/data/nka_recursive/reference_b.py"
    )
...
def test_student_infinite_loop():
    reference, ast = prepare_reference_automaton(
        ...
        path="tests/behavioral/data/nka_recursive/reference_infinite_loop.py"
    )
...
def test_student_wrong():
    reference, ast = prepare_reference_automaton(
        ...
        path="tests/behavioral/data/nka_recursive/reference_wrong.py"
    )
...
def test_student_random():
    reference, tree = prepare_reference_automaton(
        ...
        path="tests/behavioral/data/nka_recursive/reference_random.py"
    )
