...
DFA_MIN_STATES_COUNT = int(os.getenv("DFA_MIN_STATES_COUNT", "1"))
DFA_MAX_STATES_COUNT = int(os.getenv("DFA_MAX_STATES_COUNT", "1"))

NFA_MIN_STATES_COUNT = int(os.getenv("NFA_MIN_STATES_COUNT", "1"))
NFA_MAX_STATES_COUNT = int(os.getenv("NFA_MAX_STATES_COUNT", "1"))
...
RESTRICTED_SYMBOLS = set(os.getenv("RESTRICTED_SYMBOLS", ""))
